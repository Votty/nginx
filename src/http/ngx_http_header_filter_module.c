...
static u_char ngx_http_server_string[] = "Server: votty" CRLF;
static u_char ngx_http_server_full_string[] = "Server: votty" CRLF;
static u_char ngx_http_server_build_string[] = "Server: votty" CRLF;
